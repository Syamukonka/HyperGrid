...
<div class="row_between pd_h_md pd_v_sm">
    <div>
        <p class="genos txt_md"><i class="fa-solid fa-bolt txt_sm mg_r_sm"></i>Hyper<span class="text-danger">Grid</span></p>
    </div>
    <div>
        <a href="https://localhost:8087/HyperGrid/" class="btn fw500">Logout <i class="mg_l_sm fa-solid fa-arrow-right-from-bracket "></i></a>
    </div>
</div>
